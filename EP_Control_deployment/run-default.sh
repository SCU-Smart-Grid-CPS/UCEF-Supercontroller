...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/supercontroller-${timestamp}.log -T "supercontroller" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,supercontroller" &
waitUntilJoined supercontroller 1
